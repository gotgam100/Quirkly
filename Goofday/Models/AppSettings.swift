...
final class AppSettings {
    ...
    // MARK: - Keys
    private enum Keys {
        static let language = "goofday_language"
        static let theme = "goofday_theme"
        static let notificationEnabled = "goofday_notification_enabled"
        static let notificationHour = "goofday_notification_hour"
        static let notificationMinute = "goofday_notification_minute"
        static let totalCompleted = "goofday_total_completed"
        static let longestStreak = "goofday_longest_streak"
        static let lastSyncDate = "goofday_last_sync_date"
        static let iCloudSyncEnabled = "goofday_icloud_sync"
    }
    ...
    init() {
        ...
        self.iCloudSyncEnabled = defaults.object(forKey: Keys.iCloudSyncEnabled) == nil ? true : defaults.bool(forKey: Keys.iCloudSyncEnabled)
...
class NotificationManager: NSObject, UNUserNotificationCenterDelegate {
    ...
    func scheduleDailyReminder(hour: Int, minute: Int, isKorean: Bool) {
        ...
        content.title = isKorean ? "🎲 오늘의 엉뚱한 일을 뽑아볼까요?" : "🎲 Time for your Goofy task!"
        content.body = isKorean ? "일상을 깨울 작은 엉뚱함을 하나 실천해 보세요!" : "Pick a goofy task to spice up your day!"
        ...
        let request = UNNotificationRequest(identifier: "goofday.daily.reminder", content: content, trigger: trigger)
